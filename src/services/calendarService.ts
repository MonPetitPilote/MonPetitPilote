...
const CALENDRIER_BASE_2026: GrandPrix[] = [
    ...
    { round: 4, nom: "Grand Prix de Miami", circuit: "Miami", pays: "USA", date: "2026-05-03", hasSprint: true, sprintDate: "2026-05-02", statut: "programme" },
    { round: 5, nom: "Grand Prix du Canada", circuit: "Montréal", pays: "Canada", date: "2026-05-24", hasSprint: true, sprintDate: "2026-05-23", statut: "programme" },
    { round: 6, nom: "Grand Prix de Monaco", circuit: "Monaco", pays: "Monaco", date: "2026-06-07", hasSprint: false, statut: "programme" },
    { round: 7, nom: "Grand Prix de Barcelone", circuit: "Barcelona", pays: "Espagne", date: "2026-06-14", hasSprint: false, statut: "programme" },
    { round: 8, nom: "Grand Prix d'Autriche", circuit: "Spielberg", pays: "Autriche", date: "2026-06-28", hasSprint: false, statut: "programme" },
    { round: 9, nom: "Grand Prix de Grande-Bretagne", circuit: "Silverstone", pays: "Royaume-Uni", date: "2026-07-05", hasSprint: true, sprintDate: "2026-07-04", statut: "programme" },
    { round: 10, nom: "Grand Prix de Belgique", circuit: "Spa-Francorchamps", pays: "Belgique", date: "2026-07-19", hasSprint: false, statut: "programme" },
    { round: 11, nom: "Grand Prix de Hongrie", circuit: "Budapest", pays: "Hongrie", date: "2026-07-26", hasSprint: false, statut: "programme" },
    { round: 12, nom: "Grand Prix des Pays-Bas", circuit: "Zandvoort", pays: "Pays-Bas", date: "2026-08-23", hasSprint: true, sprintDate: "2026-08-22", statut: "programme" },
    { round: 13, nom: "Grand Prix d'Italie (Monza)", circuit: "Monza", pays: "Italie", date: "2026-09-06", hasSprint: false, statut: "programme" },
    { round: 14, nom: "Grand Prix d'Espagne (Madrid)", circuit: "Madrid", pays: "Espagne", date: "2026-09-13", hasSprint: false, statut: "programme" },
    { round: 15, nom: "Grand Prix d'Azerbaïdjan", circuit: "Baku", pays: "Azerbaïdjan", date: "2026-09-26", hasSprint: false, statut: "programme" },
    { round: 16, nom: "Grand Prix de Sepang", circuit: "Sepang", pays: "Malaisie", date: "2026-10-04", hasSprint: false, statut: "programme" },
    { round: 17, nom: "Grand Prix de Singapour", circuit: "Singapour", pays: "Singapour", date: "2026-10-11", hasSprint: true, sprintDate: "2026-10-10", statut: "programme" },
    { round: 18, nom: "Grand Prix des États-Unis (Austin)", circuit: "Austin", pays: "USA", date: "2026-10-25", hasSprint: false, statut: "programme" },
    { round: 19, nom: "Grand Prix du Mexique", circuit: "Mexico City", pays: "Mexique", date: "2026-11-01", hasSprint: false, statut: "programme" },
    { round: 20, nom: "Grand Prix du Brésil", circuit: "São Paulo", pays: "Brésil", date: "2026-11-08", hasSprint: false, statut: "programme" },
    { round: 21, nom: "Grand Prix de Las Vegas", circuit: "Las Vegas", pays: "USA", date: "2026-11-22", hasSprint: false, statut: "programme" },
    { round: 22, nom: "Grand Prix du Qatar", circuit: "Lusail", pays: "Qatar", date: "2026-11-29", hasSprint: false, statut: "programme" },
    { round: 23, nom: "Grand Prix d'Abou Dabi", circuit: "Yas Island", pays: "Émirats Arabes Unis", date: "2026-12-06", hasSprint: false, statut: "programme" }
];
